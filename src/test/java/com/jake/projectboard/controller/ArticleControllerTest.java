...
import com.jake.projectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    public ArticleControllerTest(@Autowired MockMvc mvc, @Autowired FormDataEncoder formDataEncoder) { // test 는 Autowired 생략 불가
        this.mvc = mvc;
...
//               .andExpect(model().attributeExists("hashtags"))
    ...
    @WithUserDetails(value = "jakeTest", userDetailsServiceBeanName = "userDetailsService", setupBefore = TestExecutionEvent.TEST_EXECUTION)
...
//                                .with(user(BoardPrincipal.of))
    ...
    @WithUserDetails(value = "jakeTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
