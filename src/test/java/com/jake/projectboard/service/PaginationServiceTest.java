...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = PaginationService.class) // 가볍게 테스트
class PaginationServiceTest {
    //    private final PaginationService sut = new;
    ...
    // 파라메터 테스트 적용
    // - test annotaion을 쓰지않고 값을 여러번 주입해서 동일한 메소드를 여러번 테스트
    @DisplayName("현재 페이지 번호와 총 페이지 수를 주면, 페이징 바 리스트를 만들어준다.")
    @MethodSource // 메소드 값을 줌
